    ...
    const captcha_callback = (err, resp) => {
      ...
      if (err) {
        ...
        if(resp.body.success) {
          let genId = slack.getChannelId('general');

          /* TODO: hacky; this appends #general channel id onto the invitation
           * I'm not sure why this isn't a feature anyways but this
           * is not the sane way to do things.
           */
          if (chanId) {
            chanId = chanId + ',' + genId;
          } else {
